...
# 1st attempt
english = ''
for i in range(5, len(str)-4):
    if str[i].islower():
        if str[i-4].islower() and str[i-3].isupper() and str[i-2].isupper() and str[i-1].isupper() and str[i+1].isupper() and str[i+2].isupper() and str[i+3].isupper() and str[i+4].islower():
            english += str[i]
