...
from UsefulFunctions import is_palindromic


def r_and_a(n):     # reverse and add
...
c = 1           # 1st candidate
while c < 10000:
    # if c % 10 == 0:     # if we don't consider 10, 100, 1000, etc.
    #     c += 1          # we have only 235 counts, which is not the answer
    #     continue        # if we were to consider them, maybe the for loop
...
# Completed on Wed, 5 Mar 2014, 21:42
# Solve by:  27633
# ---------------
# 249
# Total Time:  0.183000087738
# [Finished in 0.4s]
